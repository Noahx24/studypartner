...
export type IconName =
  | 'home' | 'today' | 'week' | 'calendar' | 'modules' | 'plus' | 'settings'
  | 'check' | 'checkCircle' | 'circle' | 'clock' | 'play' | 'pause'
  | 'arrowRight' | 'arrowLeft' | 'chevronRight' | 'chevronDown' | 'chevronUp'
  | 'close' | 'sparkles' | 'book' | 'video' | 'pencil' | 'flame' | 'trend'
  | 'target' | 'grip' | 'bell' | 'refresh' | 'mic' | 'filter' | 'search'
  | 'lightbulb' | 'fire' | 'pack' | 'download' | 'cloud';
