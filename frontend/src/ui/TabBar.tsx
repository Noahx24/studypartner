...
export type TabId = 'home' | 'today' | 'week' | 'calendar' | 'modules';
...
export function TabBar({
  ...
  return (
    <div
      className="fixed bottom-0 left-1/2 z-40 w-full max-w-[440px] -translate-x-1/2 px-3 pt-[10px] pb-[26px]"
      style={{ background: `linear-gradient(to top, ${P.bg} 55%, ${P.bg}00)` }}
    >
      <div
        className="flex rounded-card p-[6px] shadow-pill"
        ...
        {TABS.map((t) => {
          ...
          return (
            <button
              ...
              className="flex flex-1 flex-col items-center gap-[3px] rounded-[16px] py-[10px] transition-colors"
              style={{
