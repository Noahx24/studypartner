...
export const SettingsView = ({ settings, loading, onSave }: { settings: UserSettings; loading: boolean; onSave: (s: UserSettings) => Promise<void> }) => {
  ...
  return (
    <section className="max-w-xl space-y-4">
      ...
      <div className="card space-y-3">
        ...
        <select className="input" value={form.pace} onChange={(event) => setForm({ ...form, pace: event.target.value as UserSettings['pace'] })}>
