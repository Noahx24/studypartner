...
export function ModuleCard({ title, progress, remainingMinutes, nextDeadline, onClick, }) {
    return (<article onClick={onClick} className={`card space-y-3 ${onClick ? 'cursor-pointer hover:shadow-md transition' : ''}`}>
